...
public:
    ...
    virtual void start() override
    {
        ...
        animations = {Mino::SpriteAnimationData::Animation{
            asteroidFrames, Mino::SpriteAnimationData::Animation::Loop}};
        ...
        onCollisionSub = collider->onCollision().subscribe([&](auto const&) {});
