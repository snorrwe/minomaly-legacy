...
public:
    ...
    virtual void
    render(Texture const& texture, SDL_Rect* srcrect = nullptr, SDL_Rect* dstrect = nullptr)
        = 0;
    virtual void render(Texture const& texture,
                        SDL_Rect* srcrect,
                        SDL_Rect* dstrect,
    ...
    std::unique_ptr<TRenderer> createRenderer();
...
public:
    ...
    static std::unique_ptr<IRenderSystem> create(WindowSystem& window);
    ...
    loadTexture(std::string const& name, bool flag = false, Color const* color = nullptr);
...
template <typename TRenderer>
std::unique_ptr<TRenderer> IRenderSystem::createRenderer()
{
